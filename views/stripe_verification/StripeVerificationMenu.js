    ...
    <View>
      {identityVerified ? (
        ...
        <TouchableNativeReplacement
          color={'secondary'}
          onPress={() =>
            props.navigation.navigate('StripeIdentityVerification')
          }>
          <View style={styles.item}>
            <View style={styles.row}>
              <FontAwesome5Icon
      ...
      <TouchableNativeReplacement
        color={'secondary'}
        onPress={() => props.navigation.navigate('StripeAddBankAccount')}>
        <View style={styles.item}>
          <View style={styles.row}>
            <FontAwesome5Icon
              style={styles.itemicon}
...
export default withNavigation(StripeVerificationMenu);
